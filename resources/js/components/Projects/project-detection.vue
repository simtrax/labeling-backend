<template>
    <div>
        ...
        <div class="form-group">
            <label for="data">obj.data file</label>
            <textarea id="data" rows="12" class="form-control" v-model="data"></textarea>
        </div>

        <div class="form-group">
            <label for="names">obj.names file</label>
            <textarea id="names" rows="12" class="form-control" v-model="names"></textarea>
        </div>

        <div class="form-group">
            <label for="description">Config file</label>
            <textarea id="cfg" rows="35" class="form-control" v-model="cfg"></textarea>
        </div>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                names: 'object1\nobject2',
                data: this.getDataFileContents(),
                cfg: this.getCfgFileContents(),
                cfgEditor: null,
                namesEditor: null,
                dataEditor: null,
                dropzoneOptions: {
